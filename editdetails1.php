...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
      ...
      if(isset($_POST['new'])&& $_POST['new']==1){
        ...
        $sql= "UPDATE contact SET Contact_First='$fname' , Contact_Last='$lname' , Lead_Referral_Source='$rsource', Date_of_Initial_Contact='$date' , Title='$title' , Company='$company' , Industry='$industry' , Address='$address' , Address_Street_1='$address1' , Address_Street_2='$address2' , Address_City='$city' , Address_State='$state', Address_Zip='$zip' , Phone='$phone' , Email='$email' , Status='$status' , LinkedIn_Profile='$linkedin' , Background_Info='$info' , Rating='$rating'
        WHERE id='$id'";

        if($conn->query($sql)===TRUE){
          echo "Customer details edited successfully";
  ...
  ?>
    ...
    <form action="editdetails1.php" method="post" name="editshit2">
