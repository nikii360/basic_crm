...
define('PHPGRID_DB_USERNAME', 'donny');     // database user name
define('PHPGRID_DB_PASSWORD', 'kinglife'); // database password
define('PHPGRID_DB_NAME', 'crmsystem'); // database name
